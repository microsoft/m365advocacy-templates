...
resource siteConfig 'Microsoft.Web/sites/config@2024-04-01' = {
  ...
  properties: {
    ...
    // LanguageModel settings with Key Vault reference
    LanguageModel__Name: languageModelName
    LanguageModel__Endpoint: languageModelEndpoint
    LanguageModel__ApiKey: '@Microsoft.KeyVault(VaultName=${keyVaultName};SecretName=languageModelApiKey)'
